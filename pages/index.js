...
import InputImagePreview from '../components/InputImagePreviewer';
		...
		<main className='App'>
			<section className='deck'>
				<article className='grid_txt_2 '>
					{URL && (
						<>
							<InputImagePreview inputImage={inputImage} previewURL={URL} />
					...
					<FilePicker handleChange={handleChange} availableImage={!!inputImage} />
				</article>
				<OutputImage
					handleDownload={() => helpers.download(transcodedImageData.newImageSrc)}
